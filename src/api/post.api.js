...
export const getPostImageUploadUrlApi = (fileName, fileType) =>
  api.get('/post/upload-url', { params: { fileName, fileType } });
export const deletePostImageFileApi = (key) =>
  api.delete('/post/file', { data: { key } });
