...
export const updatePaymentApi        = (id, data, pgId) => api.patch(`/rent/${id}`, data, { params: pgId ? { pgId } : {} });
export const deletePaymentApi        = (id, pgId)       => api.delete(`/rent/${id}`, { params: pgId ? { pgId } : {} });
...
export const approvePaymentApi      = (id, pgId) => api.post(`/rent/${id}/approve`, {}, { params: pgId ? { pgId } : {} });
export const rejectPaymentApi       = (id, data, pgId) => api.post(`/rent/${id}/reject`, data, { params: pgId ? { pgId } : {} });
export const bulkApprovePaymentsApi  = (data, pgId) => api.post('/rent/bulk-approve', data, { params: pgId ? { pgId } : {} });
